...
const Lang = (() => {
    ...
    const translations = {
        tr: {
            ...
            menuLogin: 'Uygulamaya Giriş Yap',
            menuLogout: 'Çıkış Yap',
            menuAuthGuestSubtitle: 'Giriş yaparak tüm özellikleri açın',
            menuAuthMemberSubtitle: 'Tüm özellikler aktif durumda',
            menuFeatures: 'Özellikler',
            menuLockNote: 'Giriş yapmadan sadece Giriş Yap ve Hakkında menüleri aktiftir.',
            menuProfile: 'Hesabım',
            ...
            shareLinkTitle: 'Link Paylaş',
            shareLinkDesc: 'Linki kopyala veya paylaş',
        ...
        en: {
            ...
            menuLogin: 'Sign In to App',
            menuLogout: 'Sign Out',
            menuAuthGuestSubtitle: 'Sign in to unlock all features',
            menuAuthMemberSubtitle: 'All features are active',
            menuFeatures: 'Features',
            menuLockNote: 'Without signing in, only Sign In and About are active.',
            ...
            shareLinkDesc: 'Copy or share the link',
